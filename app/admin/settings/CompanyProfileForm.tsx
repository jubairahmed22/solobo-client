    ...
    <form onSubmit={onSubmit} className="flex flex-col gap-[16px]">
      <header className="flex flex-wrap items-end justify-between gap-[12px]">
        <div className="flex flex-col gap-[4px]">
          <h1 className="text-[24px] font-bold leading-tight text-gray-900">Company profile</h1>
      ...
      <div className="grid grid-cols-1 gap-[16px] lg:grid-cols-[1fr_320px]">
        ...
        <div className="flex flex-col gap-[16px]">
          ...
          <section className="flex flex-col gap-[16px] rounded-[8px] border border-gray-200 bg-white p-[16px] shadow-sm">
            <h2 className="text-[18px] font-semibold text-gray-900">Branding</h2>
              ...
              render={({ field }) => {
                ...
                return (
                  <div className="flex flex-col gap-1.5">
                    <ImageUploader
                      label="Company logo"
                      hint="Used in the navbar, footer, and order emails."
                      scope="brand"
                      max={1}
                      hideAlt
                      value={uploaderValue}
              ...
              render={({ field }) => {
                ...
                return (
                  <div className="flex flex-col gap-1.5">
                    <ImageUploader
                      label="Invoice logo"
                      hint="Shown on printed/PDF invoices only - falls back to the company logo above when left blank."
                      scope="brand"
                      max={1}
                      hideAlt
                      value={uploaderValue}
                    ...
                    {errors.invoiceLogo?.message ? (
                      <span className="text-xs text-ink">{errors.invoiceLogo.message}</span>
                    ) : null}
                  </div>
                );
              }}
          ...
          <section className="flex flex-col gap-[16px] rounded-[8px] border border-gray-200 bg-white p-[16px] shadow-sm">
            <div>
              <h2 className="text-[18px] font-semibold text-gray-900">Delivery charges</h2>
            ...
            <div className="rounded-[8px] border border-gray-200 bg-gray-50 p-[16px]">
              ...
              <div className="flex flex-col gap-3">
                ...
                {previewThreshold > 0 ? (
                  <div className="flex flex-col gap-[8px] rounded-[8px] border border-gray-200 bg-white px-[12px] py-[10px]">
                    ...
                    <div className="h-1.5 w-full overflow-hidden rounded-full bg-neutral-200">
                      <div className="h-full w-[40%] rounded-full bg-[#1A56DB]" />
                    </div>
                  </div>
                ) : null}
          ...
          <section className="flex flex-col gap-[16px] rounded-[8px] border border-gray-200 bg-white p-[16px] shadow-sm">
            <div className="flex items-center justify-between">
              <h2 className="text-[18px] font-semibold text-gray-900">FAQ ({faqFields.length})</h2>
              <Button
                type="button"
                variant="secondary"
                size="sm"
            ...
            {faqFields.length === 0 ? (
              <p className="rounded-[8px] border border-dashed border-gray-300 p-[16px] text-center text-[14px] text-gray-400">
                No FAQs yet. Click &ldquo;Add FAQ&rdquo; to create the first one.
              </p>
            ) : (
              <ul className="flex flex-col gap-[12px]">
                {faqFields.map((field, i) => (
                  <li key={field.id} className="flex flex-col gap-[12px] rounded-[8px] border border-gray-200 bg-gray-50 p-[16px]">
                    <div className="flex items-center justify-between">
                      <span className="inline-flex items-center gap-[6px] text-[13px] font-medium text-gray-500">
                      ...
                      <div className="flex items-center gap-[8px]">
                        ...
                        <button
                          ...
                          disabled={i === 0}
                          className="inline-flex h-[32px] w-[32px] items-center justify-center rounded-[8px] border border-gray-300 bg-white text-[13px] font-medium text-gray-900 transition duration-75 hover:bg-gray-100 disabled:cursor-not-allowed disabled:opacity-50"
                          aria-label="Move up"
                        >
                          ↑
                        </button>
                        ...
                        <button
                          type="button"
                          onClick={() => removeFaq(i)}
                          className="inline-flex h-[32px] w-[32px] items-center justify-center rounded-[8px] border border-gray-300 bg-white text-gray-500 transition duration-75 hover:bg-red-100 hover:text-red-600"
        ...
        <aside className="flex flex-col gap-[16px]">
          ...
          <section className="flex flex-col gap-3 rounded-[8px] border border-gray-200 bg-white p-[16px] shadow-sm">
            <div>
              <h2 className="text-[18px] font-semibold text-gray-900">Payment methods</h2>
                    ...
                    <label className={cn("flex items-center gap-2 py-1 text-sm", isLast ? "cursor-default" : "cursor-pointer")}>
                      ...
                      <span
                        className={cn(
                          ...
                          checked ? "border-[#1A56DB] bg-[#1A56DB]" : "border-gray-300 bg-white",
                        )}
                      >
